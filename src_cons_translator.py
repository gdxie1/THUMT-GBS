            ...
            while True:
                try:
                    ...
                    for input, encoder_output in zip(decoder_input_list, encoder_output_list):
                        ...
                        ##################
                        max_length = input["source_length"][0] + params.decode_length
                        beam_size = params.beam_size
                        # top_beams = params.top_beams
                        top_beams = 1
                        best_output = decode(encoder_output, sess, decoder_op, state_placeholders, params,
                                             cons_decoder,
                                             thumt_tm, input, top_beams,
...
def decode(encoder_output, sess, decoder_op, decoder_placeholder, params,
    ...
    search_grid = cons_decoder.search(inputs, encoder_output, sess, decoder_op, decoder_placeholder, params,start_hyp=start_hyp,
                                 constraints=input_constraints,
